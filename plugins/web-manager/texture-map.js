// 自动生成: 1.21.11 minecraft-assets 仓库纹理名映射(经文件树验证, 2026-08-08)
// 键 = mineflayer item.name; 值 = "目录/文件名"(不含 .png)。目录可为 block/item/entity/<子目录>。
// 覆盖仓库中无 <name>.png 直接文件的物品(动画帧/entity 子目录/多部件方块/规则派生名)。
"use strict";
...
const TEX_MAP = {
  ...
  'brick_slab': 'item/brick',
  'brick_stairs': 'item/brick',
  'brick_wall': 'item/brick',
  ...
  'chain_command_block': 'block/chain_command_block_front',
  ...
  'command_block': 'block/command_block_front',
  ...
  'enchanting_table': 'block/enchanting_table_top',
  'end_portal_frame': 'block/end_portal_frame_top',
  ...
  'exposed_copper_golem_statue': 'entity/copper_golem/exposed_copper_golem',
  ...
  'nether_brick_slab': 'item/nether_brick',
  'nether_brick_stairs': 'item/nether_brick',
  'nether_brick_wall': 'item/nether_brick',
  ...
  'oxidized_copper_golem_statue': 'entity/copper_golem/oxidized_copper_golem',
  ...
  'polished_blackstone_button': 'block/stone',
  'polished_blackstone_pressure_plate': 'block/stone',
  ...
  'quartz_slab': 'item/quartz',
  'quartz_stairs': 'item/quartz',
  ...
  'repeating_command_block': 'block/repeating_command_block_front',
  'resin_brick_slab': 'item/resin_brick',
  'resin_brick_stairs': 'item/resin_brick',
  'resin_brick_wall': 'item/resin_brick',
  ...
  'sculk_shrieker': 'block/sculk_shrieker_top',
  'shield': 'entity/shield/base',
  ...
  'trial_spawner': 'block/trial_spawner_top_inactive',
  ...
  'waxed_copper_golem_statue': 'entity/copper_golem/copper_golem',
  ...
  'waxed_exposed_copper_golem_statue': 'entity/copper_golem/exposed_copper_golem',
  ...
  'waxed_oxidized_copper_golem_statue': 'entity/copper_golem/oxidized_copper_golem',
  ...
  'waxed_weathered_copper_golem_statue': 'entity/copper_golem/weathered_copper_golem',
  ...
  'weathered_copper_golem_statue': 'entity/copper_golem/weathered_copper_golem',
...
// 无单张纹理可显示的物品(空槽位/测试方块) → 前端显示占位符
const NO_TEXTURE = new Set(['air', 'test_block', 'test_instance_block']);

function resolveTex(name) {
  if (!name || NO_TEXTURE.has(name)) return null;
  const v = TEX_MAP[name];
  if (!v) return null;
  const slash = v.lastIndexOf('/');
  if (slash === -1) return { dir: 'block', file: v };
  return { dir: v.slice(0, slash), file: v.slice(slash + 1) };
}

module.exports = { TEX_MAP, NO_TEXTURE, resolveTex };
